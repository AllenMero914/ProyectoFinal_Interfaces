...
export const Usuarios = () => {
  ...
  const load = async () => {
    try {
      const u = await firestoreService.getAll(firestoreService.COLLECTIONS.usuarios);
      setUsuarios(u);
    } catch { /* ignore */ }
  ...
  const crearUsuarioFirebase = async (email, password) => {
  ...
  const signOutTemp = async (authInstance) => {
